...
projectname="dashboard"  # lower case, only
resourcegroup="dashboard_rg"
...
# git clone https://github.com/apilogicserver/dashboard.git
# cd dashboard
...
az webapp create --resource-group $resourcegroup --plan myAppServicePlan --name dashboard --multicontainer-config-type compose --multicontainer-config-file devops/docker-compose-dev-azure/docker-compose-dev-azure.yml
