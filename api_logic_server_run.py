...
api_logic_server__version = '15.01.02'
api_logic_server_created__on = 'August 24, 2025 09:18:39'
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version: 15.01.02\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 15.01.02\n'
    msg += f'.. startup message: {start_up_message}\n'
