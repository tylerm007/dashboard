...
@Component({
  selector: 'WFComment-home',
  templateUrl: './WFComment-home.component.html',
  styleUrls: ['./WFComment-home.component.scss']
})
export class WFCommentHomeComponent implements AfterViewInit {
