...
@Component({
  selector: 'WFProcessPriority-home',
  templateUrl: './WFProcessPriority-home.component.html',
  styleUrls: ['./WFProcessPriority-home.component.scss']
})
export class WFProcessPriorityHomeComponent implements AfterViewInit {
