...
@Component({
  selector: 'ValidationCheck-home',
  templateUrl: './ValidationCheck-home.component.html',
  styleUrls: ['./ValidationCheck-home.component.scss']
})
export class ValidationCheckHomeComponent implements AfterViewInit {
