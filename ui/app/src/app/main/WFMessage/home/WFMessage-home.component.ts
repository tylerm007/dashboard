...
@Component({
  selector: 'WFMessage-home',
  templateUrl: './WFMessage-home.component.html',
  styleUrls: ['./WFMessage-home.component.scss']
})
export class WFMessageHomeComponent implements AfterViewInit {
