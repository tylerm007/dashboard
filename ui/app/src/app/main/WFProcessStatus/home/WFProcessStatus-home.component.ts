...
@Component({
  selector: 'WFProcessStatus-home',
  templateUrl: './WFProcessStatus-home.component.html',
  styleUrls: ['./WFProcessStatus-home.component.scss']
})
export class WFProcessStatusHomeComponent implements AfterViewInit {
